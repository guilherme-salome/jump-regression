...
f2l = legend({[tkr ' return vs. ' stkr ' jump return'],['Jump Regression: $\hat{r}_t^{' stkr '}=\hat{\beta}_{jump}r_t^{d,' tkr '}$'],['$\hat{\beta}_{jump}=' num2str(beta) '$, CI:[' num2str(CI_low) ',' num2str(CI_up) '], $H_0$: ' rej]},'Interpreter','latex','Location','northwest');
% change font size
